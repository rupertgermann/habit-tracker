...
- **Responsive layout** - mobile navigation dock, wide-screen navigation rail, and tablet split views for habit list/detail workflows.
...
- `NavigationContext` keeps the responsive navigation dock/rail aligned with the active route.

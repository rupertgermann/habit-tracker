...
- **Dashboard** - Signal Room overview with an oversized daily score, seven-day frequency, live Habit circuit, quick Yes/No Completion, and Count Habit steppers.
...
- **Responsive layout** - a six-stop mobile route strip, desktop control rail, and wide-screen split views for Habit list/detail workflows.
...
- `NavigationContext` keeps the mobile route strip and desktop control rail aligned with the active route.
